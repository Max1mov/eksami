...
class User {
	...
	function createUser($create_email, $password_hash){
		...
		$stmt = $this->connection->prepare("SELECT email FROM eksam_user WHERE email = ?");
		...
		$stmt = $this->connection->prepare("INSERT INTO eksam_user (email, password) VALUES (?, ?)");
	...
	function loginUser($email, $password_hash){
		...
		$stmt = $this->connection->prepare("SELECT id, email FROM eksam_user WHERE email=? AND password=?");
